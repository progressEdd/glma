...
git submodule update --init 00-supporting-files/data/linux-kernel
```
...
|--------|-------------|---------------|---------|
| `linux_kernel` | Linux kernel codebase exploration with AI agents for documentation | `02-worktrees/linux_kernel` | 2026-04-08 |

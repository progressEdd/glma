...
- **linux_kernel**: Exploration of the Linux kernel codebase using AI agents for documentation and analysis
  ```bash
  git worktree add 02-worktrees/linux_kernel linux_kernel
  ```
